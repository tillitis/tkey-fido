 ...
 */
extern int rng_generate(uint8_t * output, unsigned output_size);
...
/*
 * ECDH/ECDSA try to import private key from bytes
 *
 * [out] pub: on success, holds the public key, as two big-endian integers
 * [in] priv: possible private key (scalar) as a big-endian integer
 *
 * return:  P256_SUCCESS on success
 *          P256_INVALID_PRIVKEY on failure
 */
